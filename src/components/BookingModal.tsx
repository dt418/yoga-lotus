...
const BookingModal: React.FC<BookingModalProps> = ({ isOpen, onClose }) => {
	...
	return (
		...
		>
			...
			>
				<div className="bg-lotus-black bg-opacity-[63%] overflow-hidden">
					<button
						type="button"
						onClick={onClose}
					...
					<div className="">
						<div className="px-[80px]">
							<h3 className="text-2xl font-suse text-lotus-main mb-2 uppercase">
								JOIN THE LOTUS GLOW
							</h3>
							<h2 className="text-4xl font-gotham_black text-white mb-8 uppercase">
								<span className="text-lotus-main">BOOK</span> A SESSION
							</h2>
						</div>
						<form
							onSubmit={handleSubmit(onSubmit)}
							className="space-y-6 bg-lotus-main inset-0 px-[80px] pb-[80px] pt-[48px]"
							noValidate
						>
								...
								<div>
									...
									<input
										...
										className={cn(
											...
											"text-white font-suse placeholder:text-white/75",
